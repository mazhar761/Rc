...
"""
Telegram Vehicle RC Lookup Bot
Using RapidAPI Vehicle RC Information V2 API
"""
...
BOT_TOKEN =  "7405870524:AAEnLIRPbMTacVA3hGSi2mv4MWWZQ-9alAI"
RAPIDAPI_KEY = "831bdeee13msh9f02c3cc8964a0ap147e54jsn1c198bdebcef"

API_URL = "https://vehicle-rc-information-v2.p.rapidapi.com/"

API_HOST = "vehicle-rc-information-v2.p.rapidapi.com"
...
🔢 Registration Number:
{get_value(data, "registration_number", "vehicle_number", "reg_no")}

👤 Owner Name:
{get_value(data, "owner_name", "owner")}

🏠 Address:
{get_value(data, "address", "present_address")}

🏢 RTO:
{get_value(data, "rto", "registering_authority")}

🚘 Vehicle Model:
{get_value(data, "model", "model_name")}

🏭 Manufacturer:
{get_value(data, "manufacturer", "maker_description")}

🚗 Vehicle Class:
{get_value(data, "vehicle_class")}

⛽ Fuel Type:
{get_value(data, "fuel_type", "fuel")}

📅 Registration Date:
{get_value(data, "registration_date", "reg_date")}

📅 Insurance Upto:
{get_value(data, "insurance_upto")}

📅 Fitness Upto:
{get_value(data, "fitness_upto")}

🔧 Engine Number:
{get_value(data, "engine_number")}

🔩 Chassis Number:
{get_value(data, "chassis_number")}

📍 State:
{get_value(data, "state")}

🏦 Financer:
{get_value(data, "financer")}

📆 Manufacturing Year:
{get_value(data, "manufacturing_year")}

🔒 RC Status:
{get_value(data, "rc_status")}
"""
...
async def pdf_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    vehicle_number = data.get(
        "registration_number",
        data.get("vehicle_number", "vehicle")
    )
